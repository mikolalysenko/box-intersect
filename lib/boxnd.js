...
//  takes O(n) time
function partitionBoxes2(d, axis, start, end, boxes, id, pred, a, b) {
  var elemSize = 2*d
  var boxPtr  = elemSize * start
  var dstPtr  = boxPtr
  var ptr     = start
  var offset0 = axis
  var offset1 = d+axis
  for(var i=start; i<end; ++i, boxPtr += elemSize) {
...
function partitionBoxes1(d, axis, start, end, boxes, id, pred, a) {
  var elemSize = 2*d
  var boxPtr  = elemSize * start
  var dstPtr  = boxPtr
  var ptr     = start
...
function partitionBoxesContainsHalfInterval(d, axis, start, end, boxes, id, lo, hi) {
  return partitionBoxes2(d, axis, start, end, boxes, id, intervalContainsHalfInterval, lo, hi)
}

function intervalContainsPoint(a0, a1, p) {
  return a0 <= p && p <= a1
}

function partitionBoxesContainsPoint(d, axis, start, end, boxes, id, p) {
  return partitionBoxes1(d, axis, start, end, boxes, id, intervalContainsPoint, p)
}

function intervalContainsPointProper(a0, a1, p) {
  return a0 < p && p <= a1
}

function partitionBoxesContainsPointProper(d, axis, start, end, boxes, id, p) {
  return partitionBoxes1(d, axis, start, end, boxes, id, intervalContainsPointProper, p)
}

function intervalStartLessThan(a0, a1, p) {
  return a0 < p
}

function partitionBoxesStartLessThan(d, axis, start, end, boxes, id, v) {
  return partitionBoxes1(d, axis, start, end, boxes, id, intervalStartLessThan, v)
}

function intervalStartLessThanEqual(a0, a1, p) {
  return a0 <= p
}

function partitionBoxesStartLessThanEqual(d, axis, start, end, boxes, id, v) {
  return partitionBoxes1(d, axis, start, end, boxes, id, intervalStartLessThanEqual, v)
}
...
function partitionBoxesEndLessThan(d, axis, start, end, boxes, id, v) {
  return partitionBoxes1(d, axis, start, end, boxes, id, intervalEndLessThan, v)
}
...
function findMedian(d, axis, start, end, boxes, ids) {
  ...
  while(lo < hi) {
    ...
    pivot = partitionBoxesStartLessThan(
      d, axis, 
      lo, hi-1, boxes, ids,
      value)
...
function boxIntersectRec(
  ...
  */
  ...
  var Imid = partitionBoxesContainsHalfInterval(
    d, axis, 
    redStart, redEnd, red, redIndex, 
    lo, hi)
  ...
  if(Bmid === blueStart) {
    ...
    var Bmid2 = partitionBoxesStartLessThanEqual(
        d, axis,
        blueStart, blueEnd, blue, blueIndex,
        midV)
    ...
    if(Bmid2 === blueEnd) {
      ...
      var redPT
      if(flip) {
        redPT = partitionBoxesContainsPointProper(
          d, axis, 
          Imid, redEnd, red, redIndex, 
          midV)
      } else {
        redPT = partitionBoxesContainsPoint(
          d, axis, 
          Imid, redEnd, red, redIndex, 
          midV)
      }
  ...
  var redLT = partitionBoxesStartLessThan(
      d, axis, 
      Imid, redEnd, red, redIndex, 
      midV)
  if(redLT > Imid) {
  ...
  var redGE = partitionBoxesEndLessThan(
      d, axis, 
      Imid, redEnd, red, redIndex,
      midV)
  if(redGE < redEnd) {
