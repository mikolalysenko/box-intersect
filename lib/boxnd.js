...
var BOX_ISTACK  = pool.mallocInt32(1024)
var BOX_DSTACK  = pool.mallocDouble(1024)
...
function boxIntersectIter(
  ...
  while(top > 0) {
    ...
    */
    ...
    if(Imid > redStart) {
      if(flip) {
        ...
        if(redO !== redStart && (
          ...
          //    [blueO, blueEnd] with [redStart, Imid]
          //
    ...
    //TODO: Handle case where redEnd - Imid < bruteForceCutoff
