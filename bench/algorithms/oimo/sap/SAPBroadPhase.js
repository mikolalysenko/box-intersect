...
var SAPAxis = require('./SAPAxis')
var SAPProxy = require('./SAPProxy')

/**
* A broad-phase collision detection algorithm using sweep and prune.
* @author saharan
*/
var SAPBroadPhase = function(){
    ...
    this.axesD[0]=new SAPAxis();
    this.axesD[1]=new SAPAxis();
    this.axesD[2]=new SAPAxis();
    this.axesS[0]=new SAPAxis();
    this.axesS[1]=new SAPAxis();
    this.axesS[2]=new SAPAxis();
    this.index1=0;
    this.index2=1;
}
